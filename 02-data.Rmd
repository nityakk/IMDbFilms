...
```{r}
basics <- read.csv("title.basics.tsv", sep = '\t', header = TRUE, fill = TRUE, na.strings = "NA")
basics[basics == "\\N"] <- NA
```
...
```{r}
crew <- read.csv("title.crew.tsv", sep = '\t', header = TRUE, fill = TRUE, na.strings = "NA")
crew[crew == "\\N"] <- NA
```
...
```{r}
ratings <- read.csv("title.ratings.tsv", sep = '\t', header = TRUE, fill = TRUE, na.strings = "NA")

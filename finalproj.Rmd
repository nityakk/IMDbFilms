...
```{r}
basics <- read.csv("https://media.githubusercontent.com/media/nityakk/IMDbFilms/main/sources/title.basics.tsv", sep = '\t', header = TRUE, fill = TRUE, na.strings = "NA")
basics[basics == "\\N"] <- NA
```
...
```{r}
crew <- read.csv("https://media.githubusercontent.com/media/nityakk/IMDbFilms/main/sources/title.crew.tsv", sep = '\t', header = TRUE, fill = TRUE, na.strings = "NA")
crew[crew == "\\N"] <- NA
```
...
```{r}
ratings <- read.csv("https://media.githubusercontent.com/media/nityakk/IMDbFilms/main/sources/title.ratings.tsv", sep = '\t', header = TRUE, fill = TRUE, na.strings = "NA")
...
```{r}
write.csv(groupedGenre,"sources_short/groupedGenres.csv", row.names = FALSE)
write.csv(groupedGenre_complete,"sources_short/groupedGenres_complete.csv", row.names = FALSE)
```


```{r}
for(type in unique(groupedGenre_complete$titleType)) {

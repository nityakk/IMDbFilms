...
missing_plots <- function(data, percent = FALSE) {
 ...
 # missing_patterns
  ...
  # main plot
  main <- ggplot(missing_patterns3, aes(x = key, y = fct_rev(fct_reorder(missing_patterns3$id,as.integer(missing_patterns3$id))), 
...
```
<br/>We have plotted the graphs that denotes the missing values in the 'name' dataset that we have used. The 'name' dataset includes the following information:<br/>
